...
const Clima = ({data}) => {
  ...
  //Siempre que usamos imagenes proveniente de internet, especificar un ancho y un alto.
  return (
    <View style={styles.clima}>
      <Text style={[styles.texto, styles.actual]}>
        ...
        <Image
          ...
          }} //Uri es para especificar la fuente de internet donde esta alojada la img
        />
      </Text>
